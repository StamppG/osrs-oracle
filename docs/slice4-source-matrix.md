...
|---|---|---|---|
| Seed box | SEED_BOX | OBSERVED_CONTAINER | READY |
| Tackle box | TACKLE_BOX | OBSERVED_CONTAINER | READY |
| Forestry kit | FORESTRY_KIT | OBSERVED_CONTAINER | READY |
...
| CoX private storage | RAIDS_PRIVATESTORAGE | ACTIVITY_STORAGE | IMPLEMENTED_SOURCE_PROVEN |
| CoX shared storage | RAIDS_SHAREDSTORAGE | ACTIVITY_STORAGE / SHARED | IMPLEMENTED_SOURCE_PROVEN |
| TOA mid-raid supplies | TOA_MIDRAIDLOOT_* | ACTIVITY_STORAGE | READY |
| TOA reward chest | TOA_CHESTS | ACTIVITY_STORAGE | READY |
